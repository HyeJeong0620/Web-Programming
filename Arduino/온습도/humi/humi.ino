...
void loop() {
  ...
  //String url = "/bssm2_4/upload.php?did=device1&temp="+String(temp)+"&humi=" + String(h); // 온습도 센서 값 전달
  ...
  while(client.available()){
    ...
    if(line.indexOf("{\"pin\"") != -1){
      Serial.println(line);
      // 현재 line이라는 변수 안에 서버가 전송한 json이 들어있다!
