...
const char* host = "10.150.150.67"; // 내 서버의 주소 cmd에서 ipconfig
const int Port = 80;
...
void loop() {
  ...
  //클라이언트가 서버의 /bssm2_4/test/upload.php에 센서데이터를 아래와 같은 url로 전송한다
  // /bssm2_4/upload.php
  String url = "/bssm2_4/test/upload.php?did=device1&temp="+String(temp)+"&humi=" + String(humi);
